# Generated by Django 2.2.4 on 2019-08-28 06:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_type', models.IntegerField(choices=[(0, '余额'), (1, '银行卡'), (2, '支付宝'), (3, '支付宝')], default=0, verbose_name='支付方式')),
                ('pay_status', models.IntegerField(choices=[(0, '待支付'), (1, '已支付'), (2, '带收货'), (3, '已收货'), (4, '完成'), (5, '取消')], default=0, verbose_name='订单状态')),
